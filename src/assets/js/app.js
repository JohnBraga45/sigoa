...
window.initSlideMenu = function () {
	...
	// window.initSlideMenu = ''Teste;

	var inicio = function init() {
		var $this = Sidemenu;
	...
	// Sidebar overlay
	var sidebarOverlay = function sidebar_overlay($target) {
		if ($target?.length) {
	...
	// 	console.log('Tamanho : ',$('.datatable')?.length);
	// 	$('.datatable').DataTable({
	// 		"bFilter": false,
	// 	});
	// }
